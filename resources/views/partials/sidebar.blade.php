<div id="sidebar" class="sidebar bg-gray-800 text-white w-64 fixed h-full lg:block">
    <div class="p-4 flex items-center border-b border-gray-700">
        <img src="https://ui-avatars.com/api/?name=Admin+User&background=667eea&color=fff" alt="Logo"
            class="h-10 w-10 rounded-full">
        <span class="ml-3 font-semibold text-lg">Admin Panel</span>
    </div>

    <nav class="mt-6">
        <div>
            <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 bg-gray-700 text-white">
